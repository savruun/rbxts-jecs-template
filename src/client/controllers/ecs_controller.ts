...
import { client, shared } from '@shared/paths';
import { load_systems } from '@util/load_systems';
...
export class ECSController implements OnStart {
  private readonly systems = load_systems(client.WaitForChild('systems') as Folder);
  private readonly shared_systems = load_systems(shared.WaitForChild('systems') as Folder);
